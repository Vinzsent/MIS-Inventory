    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">Welcome to MIS Inventory System</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Management Information System Department<br />
                        Streamline your inventory management with our comprehensive system.
                    </p>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-white lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#161615] flex items-center justify-center p-8"
                >
                    <img
                        src="/images/mislogo.png"
                        alt="MIS - Management Information System"
                        class="w-full h-auto max-w-full object-contain opacity-100 transition-all duration-750 starting:opacity-0"
                    />
                </div>
            </main>
        </div>
